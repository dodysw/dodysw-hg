...
// @exclude http://us.detik.com/*.php*
// @include http://www.detik.com/*
// @exclude http://www.detik.com/*.php*
// ==/UserScript==

var DEBUG = false;
/*---browser specific functions---*/
function log (msg) {if (DEBUG) opera.postError(msg);}
function sendRequest(msg) {opera.extension.postMessage(JSON.stringify(msg));}
...
opera.extension.onmessage = function(event) {handle_request(JSON.parse(event.data));};
